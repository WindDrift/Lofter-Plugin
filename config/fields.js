...
export const LOFTER_FIELDS = [
  ...
  {
    key: 'enablePureTextImageFooterStats',
    type: 'switch',
    default: true,
    label: '纯文图片页脚统计',
  ...
  {
    key: 'lofterLoginEnabled',
    type: 'switch',
    default: false,
    label: '启用Lofter登录',
    bottomLabel: '开启后使用下方 Cookie Key 与 Cookie 值访问登录后内容',
    group: '通用设置',
    order: 70
  },
  {
    ...
    label: 'Lofter登录Key',
    bottomLabel:
      '登录 Key 参考表：Authorization、LOFTER-PHONE-LOGIN-AUTH、LOFTER_SESS、NTES_SESS。获取方式：浏览器 F12 → Network → XHR → 点开请求 → Cookies → 复制对应 loginKey 的值',
    group: '通用设置',
    order: 80
  },
  {
    ...
    label: 'Lofter登录Auth',
    bottomLabel:
      '填写 lofterLoginKey 对应的 Cookie 值。获取方式：浏览器 F12 → Network → XHR → 点开请求 → Cookies → 复制对应 loginKey 的值',
    group: '通用设置',
    order: 90
  },
  ...
  },
  {
    ...
    default: true,
    label: '发送博文基础信息',
    bottomLabel: '是否发送博文链接、发布时间、博文ID；标签链接关闭时普通标签也显示在这里',
    group: '发送内容管理',
    order: 20
  },
  {
    ...
    default: true,
    label: '发送标签链接',
    bottomLabel: '开启时单独发送带链接的标签消息；关闭时在博文基础信息中显示普通标签',
    group: '发送内容管理',
    order: 30
  },
  {
    ...
    default: true,
    label: '发送互动数据',
    bottomLabel: '是否发送回复、点赞、推荐、收藏、热度',
    group: '发送内容管理',
    order: 40
  },
  {
  ...
  },
  {
    ...
    default: true,
    label: '发送正文标题',
    bottomLabel: '是否发送正文标题；纯文图片模式中长图仍保留标题',
    group: '发送内容管理',
    order: 50
  },
  {
  ...
  },
  {
    ...
    default: true,
    label: '发送图片',
    bottomLabel: '是否发送图片本体；关闭后仍可单独发送原图链接',
    group: '发送内容管理',
    order: 70
  },
  {
    ...
    default: true,
    label: '发送原图链接',
    bottomLabel: '是否为每张图片发送对应的原图链接，和发送图片本体相互独立',
    group: '发送内容管理',
    order: 80
  },
  {
    key: 'sendImageLimitTip',
    type: 'switch',
    default: true,
    label: '发送大小限制提示',
    bottomLabel: '图片触发大小限制时，是否发送全局调整提示',
    group: '发送内容管理',
    order: 90
  },
  {
    ...
    default: true,
    label: '发送解析统计',
    bottomLabel: '是否发送字数、自然段、图片数、耗时、今日和本群解析次数',
    group: '发送内容管理',
    order: 100
  },
  {
  ...
  // ============== 列表浏览设置 ==============
  {
    key: 'blogListPageSize',
    type: 'number',
    default: 10,
    min: 1,
    max: 20,
    label: '博主主页列表数量',
    bottomLabel: '博主主页列表每次显示的帖子数量',
    group: '列表浏览设置',
    order: 10
  },
  {
  ...
  },
  {
    ...
    max: 3600,
    label: '列表缓存有效期',
    bottomLabel: '列表缓存有效期，单位：秒，用于 #lofter解析 序号',
    group: '列表浏览设置',
    order: 30
  },
  {
  ...
  // ============== 每日一图设置 ==============
  {
    key: 'dailyImageEnabled',
    type: 'switch',
    default: false,
    label: '每日一图功能',
    bottomLabel: '开启后可在群聊中订阅标签，每天定时推送随机博文',
    group: '每日一图设置',
    order: 10
  },
  {
    key: 'dailyImagePushTime',
    type: 'input',
    default: '08:00',
    label: '每日推送时间',
    bottomLabel: '每日推送时间，格式 HH:mm（如 08:00）',
    group: '每日一图设置',
    order: 20
  },
  {
    key: 'dailyImageMaxSubscriptions',
    type: 'number',
    default: 50,
    min: 1,
    max: 500,
    label: '最大订阅数量',
    bottomLabel: '全局最大订阅数量限制',
    group: '每日一图设置',
    order: 30
  },
  {
    key: 'dailyImagePushInterval',
    type: 'number',
    default: 3,
    min: 1,
    max: 60,
    label: '多标签推送间隔',
    bottomLabel: '同一群订阅多个标签时，每次推送之间的间隔时间（分钟）',
    group: '每日一图设置',
    order: 40
  }
]
