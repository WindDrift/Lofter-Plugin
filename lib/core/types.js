 ...
 * @property {string}        permalink   permalink 片段
 */
 ...
 * @property {boolean} [sendCollectionInfo]            发送合集信息
 * @property {boolean} [sendCollectionList]            发送合集文章列表
 * @property {number}  [collectionListLimit]           合集列表显示数量
 ...
 * @property {number} publishTime - 发布时间戳
 * @property {number} photoCount - 图片数量
 * @property {string} thumbnailUrl - 首图缩略图 URL
 * @property {number} ccType - CC协议类型
 * @property {string} permalink - 永久链接
 * @property {string[]} tagList - 标签列表
 * @property {boolean} forbidShare - 是否禁止分享
 ...
 * @property {'blog'|'tag'|'collection'} type - 列表类型
 * @property {Array} items - 标准列表项数组
 * @property {object|null} pageState - 分页状态
 */
